        ...
        case 1:
                {
                     ...
                     SHARP_DIST[SHARP_LEFT]= (SHARP_TEMP[0]+SHARP_TEMP[1]+SHARP_TEMP[2]+SHARP_TEMP[3]+SHARP_TEMP[4])/3;
//                     ADC_Value = read_adc(1);
//                     SHARP_Vo  = (float)ADC_Value/51;   
        ...
        case 2:
                {
                     ...
                     SHARP_DIST[SHARP_RIGHT]= (SHARP_TEMP[0]+SHARP_TEMP[1]+SHARP_TEMP[2]+SHARP_TEMP[3]+SHARP_TEMP[4])/3;
